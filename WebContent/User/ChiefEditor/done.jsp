...
<div class="pages">
   <img src="images/logoo.png">
     <p align="center"><font size="6"><b>已发布文章如下</b></font></p>
   <table border="1" cellspacing=0>
     ...
     <%
       ...
       for(int i=0;i<a;i++){
         ...
         char con=n.getZeditor().charAt(0);
         if(first=='1'&&con=='D'){
     %>  
      <tr>
      <td><%=n.getNewid()%></td>
      ...
      <td><a href="jsp/ok.jsp?reporter=<%=n.getReporter()%>&title=<%=n.getTitle()%>&type=<%=n.getType()%>&content=<%=n.getContent()%>&zcomment=<%=n.getZcomment()%>">查看</a> 
     </tr>
     <% } 
         }
         a=nu.text("Sports");

...
<div class="infomation">
   ...
   <p align="center"><font size="6"><b>查看评论</b></font></p>
   <form action="../not.jsp">   
       <ul>
          <li><a><b>新闻序号</b></a>&ensp;<%=request.getParameter("newid") %></li>
          <li><a><b>标题</b> &emsp;&emsp;<%=request.getParameter("title") %></a></li>
          <li><a><b>类型</b> &emsp;&emsp;<%=request.getParameter("type") %></a></li>
       </ul>
       <div class="look"><%=request.getParameter("comment") %></div>
       <div class="sub">
            <a href="../not.jsp" onclick="link"><input name="onco" type="submit" value="返回"/></a>
       </div>
   </form>
</div>
</body>

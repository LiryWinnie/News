...
<div class="pages">
   ...
   <table border="1" cellspacing=0>
     ...
     %>  
      ...
      <td><a href="reset.jsp?newid=<%=n.getNewid()%>&title=<%=n.getTitle()%>&type=<%=n.getType()%>&content=<%=n.getContent()%>">修改</a> 
     ...
     %>  
      ...
      <td><%=n.getStatus()%></td>
      <td><%=n.getCreatetime()%></td>
      <td><a href="reset.jsp?title=<%=n.getTitle()%>&newid=<%=n.getNewid()%>&type=<%=n.getType()%>&content=<%=n.getContent()%>">修改</a> 
      <a href="jsp/delete.jsp?newid=<%=n.getNewid()%>&type=<%=n.getType()%>">删除</a></td>
     </tr>
     <% }  }
       a=nu.text("Sports");

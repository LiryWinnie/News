...
<div class="pages">
   <img src="images/logoo.png">
     <p align="center"><font size="6"><b>未通过文章如下</b></font></p>
   <table border="1" cellspacing=0>
     ...
     %>  
      ...
      <td><a href="jsp/comment.jsp?newid=<%=n.getNewid()%>&title=<%=n.getTitle()%>&type=<%=n.getType()%>&comment=<%=n.getComment()%>">查看</a> 
      <a href="reset.jsp?newid=<%=n.getNewid()%>&title=<%=n.getTitle()%>&type=<%=n.getType()%>&content=<%=n.getContent()%>">修改</a>
      <a href="jsp/delete.jsp?newid=<%=n.getNewid()%>&type=<%=n.getType()%>">删除</a></td>
     </tr>
     <% } 
         }
       a=nu.text("Sports");
